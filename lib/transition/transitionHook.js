...
var TransitionHook = (function () {
    function TransitionHook(transition, stateContext, registeredHook, options) {
        ...
        this.rejectIfSuperseded = function () {
            return _this.registeredHook.hookType.rejectIfSuperseded && _this.options.current() !== _this.options.transition;
        };
    ...
    TransitionHook.prototype.invokeHook = function () {
        ...
        var errorHandler = hook.hookType.getErrorHandler(this);
        var resultHandler = hook.hookType.getResultHandler(this);
