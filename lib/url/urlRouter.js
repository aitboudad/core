...
function update(rules, otherwiseFn, evt) {
    ...
    function check(rule) {
        var handled = rule(coreservices_1.services.$injector, $loc);
        if (!handled)
            return false;
        ...
        var strategies = {
            matcher: function (_what, _handler) {
                ...
                return common_1.extend(function () {
                    return handleIfMatch(coreservices_1.services.$injector, $stateParams, _handler, _what.exec($loc.path(), $loc.search(), $loc.hash()));
                }, {
            ...
            regex: function (_what, _handler) {
                ...
                return common_1.extend(function () {
                    return handleIfMatch(coreservices_1.services.$injector, $stateParams, _handler, _what.exec($loc.path()));
                }, {
...
var UrlRouter = (function () {
    ...
    UrlRouter.prototype.listen = function () {
        var _this = this;
        return this.listener = this.listener || coreservices_1.services.location.onChange(function (evt) { return update(_this.urlRouterProvider.rules, _this.urlRouterProvider.otherwiseFn, evt); });
    };
    /**
     * Internal API.
     */
    ...
    UrlRouter.prototype.push = function (urlMatcher, params, options) {
        ...
        coreservices_1.services.location.setUrl(urlMatcher.format(params || {}), replace);
    };
    /**
